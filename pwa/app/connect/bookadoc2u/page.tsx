/**
 * Connect to BookADoc2U Practice
 */
...
const BOOKADOC2U_PRACTICE_ID = 'bookadoc2u-practice-id'; // TODO: Replace with actual practice ID

export default function ConnectBookADoc2UPage() {
  ...
  const handleConnect = async () => {
    ...
    try {
      ...
      router.push('/connect/status?success=true&practice=BookADoc2U');
    } catch (err) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-white to-sky-50 pb-20 md:pb-8">
      <Header title="Connect to BookADoc2U" showBack />
      ...
      <main className="max-w-2xl mx-auto px-4 py-8">
        ...
        <Card className="mb-6">
          <h1 className="text-2xl font-bold text-navy-600 mb-4">BookADoc2U</h1>
          <p className="text-gray-600 mb-6">
            Connect to BookADoc2U for healthcare services and appointment management.
          </p>
          ...
          <div className="space-y-4">
            <Button
              ...
              disabled={connecting}
            >
              {connecting ? 'Connecting...' : 'Connect to BookADoc2U'}
            </Button>
            <Button
              variant="outline"
              className="w-full"
