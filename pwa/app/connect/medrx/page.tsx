...
const MEDRX_PRACTICE_ID = 'medrx-practice-id'; // TODO: Replace with actual practice ID

export default function ConnectMedRxPage() {
  ...
  const handleConnect = async () => {
    ...
    try {
      ...
      router.push('/connect/status?success=true&practice=MedRx');
    } catch (err) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-white to-sky-50 pb-20 md:pb-8">
      <Header title="Connect to MedRx" showBack />
      ...
      <main className="max-w-2xl mx-auto px-4 py-8">
        ...
        <Card className="mb-6">
          <h1 className="text-2xl font-bold text-navy-600 mb-4">MedRx</h1>
          <p className="text-gray-600 mb-6">
            Connect to MedRx for pharmacy and medication management services.
          </p>
          ...
          <div className="space-y-4">
            <Button
              ...
              disabled={connecting}
            >
              {connecting ? 'Connecting...' : 'Connect to MedRx'}
            </Button>
            <Button
              variant="outline"
              className="w-full"
