/**
 * Local ESLint plugin: no-impure-render
 * Prevents impure/side-effectful operations during React render.
 * Allows map/filter/reduce in JSX (informational guard handled elsewhere).
 */
