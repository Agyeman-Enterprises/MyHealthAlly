-- Test Data for MHA (SAFE VERSION)
-- This version uses INSERT ... ON CONFLICT to avoid duplicate errors
-- Safe to run multiple times

-- ============================================
-- TEST USERS (Insert only if not exists)
-- ============================================
...
-- ============================================
-- TEST CLINICIAN (Insert only if not exists)
-- ============================================
...
-- ============================================
-- TEST PATIENTS (Insert only if not exists)
-- ============================================
...
-- ============================================
-- TEST VITALS (Insert only if not exists)
-- ============================================
...
-- ============================================
-- TEST MESSAGE THREADS (Insert only if not exists)
-- ============================================
...
-- ============================================
-- TEST MESSAGES (Insert only if not exists)
-- ============================================
...
-- ============================================
-- TEST TASKS (Insert only if not exists)
-- ============================================
...
-- ============================================
-- TEST ALERTS (Insert only if not exists)
-- ============================================
...
-- ============================================
-- UPDATE MESSAGE THREAD COUNTS (Safe update)
-- ============================================
...
AND (clinician_unread_count IS NULL OR clinician_unread_count = 0);
