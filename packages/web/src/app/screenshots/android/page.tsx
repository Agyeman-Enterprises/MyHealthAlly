...
export default function AndroidScreenshotsPage() {
  ...
  return (
    <div className="min-h-screen bg-myh-bg p-8">
      <div className="max-w-7xl mx-auto space-y-8">
        <div>
          <h1 className="text-3xl font-semibold text-myh-text">Android Play Store Screenshots</h1>
          <p className="text-muted-foreground mt-2">Pre-sized phone mockups for Play Store submission</p>
        </div>
        ...
        <div className="flex justify-center">
          <div className="relative">
            {/* Android Phone Frame */}
            <div className="w-[360px] h-[800px] bg-gray-800 rounded-[2rem] p-1.5 shadow-2xl">
              <div className="w-full h-full bg-myh-bg rounded-[1.75rem] overflow-hidden relative">
                {/* Status Bar - Android Style */}
                <div className="absolute top-0 left-0 right-0 h-10 bg-myh-bg flex items-center justify-between px-4 text-xs font-medium text-myh-text z-10">
                  <span>9:41</span>
                ...
                <div className="absolute bottom-0 left-0 right-0 h-16 bg-myh-bg border-t border-myh-border flex items-center justify-around z-10">
                  <div className="w-1 h-1 bg-myh-text rounded-full" />
                  <div className="w-8 h-1 bg-myh-text rounded-full" />
                  <div className="w-6 h-6 border-2 border-myh-text rounded-full" />
                </div>

                {/* Content */}
                <div className="pt-10 pb-16 h-full overflow-y-auto">
                  <ScreenshotComponent />
                </div>
              </div>
            </div>
